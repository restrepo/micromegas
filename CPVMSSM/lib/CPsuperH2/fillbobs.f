...
*      write(*,22) bdtt*1.d7,bdtt_sm*1.d7
      ...
      write(*,24) dmbs_susy
C! Micromegas Print
      write(321, fmt='("Bsmumu",2x,1PE16.8)') bsmm
      write(321, fmt='("Bsg",2x,1PE16.8)') raux_h(135)*1.d-4
      write(321, fmt='("Bulnu",2x,1PE16.8)') rbtaunu
      write(321, fmt='("Bdll",2x,1PE16.8)') bdtt
      write(321, fmt='("ABsg",2x,1PE16.8)') raux_h(136)
      write(321, fmt='("deltMd",2x,1PE16.8)') dmbd_susy
      write(321, fmt='("deltMs",2x,1PE16.8)') dmbs_susy
