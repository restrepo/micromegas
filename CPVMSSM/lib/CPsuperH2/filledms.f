...
*
      write(321,fmt='("EDMel",2x,1PE16.8)') deoe_e(1)*GEVTOCM 
     ...
     .      ,deoe_s(4)*GEVTOCM,deoe_s(5)*GEVTOCM
      print*,'---------------------------------------------------------'
      print*,'The Chromo-Electric EDMs of particles in cm: u, d: '
      print*,'---------------------------------------------------------'
...
*STORE
      ...
      write(321,fmt='("EDMth",2x,1PE16.8)') dtl
...
*
      ...
      write(321,fmt='("EDMHg",2x,1PE16.8)') d_hg 
