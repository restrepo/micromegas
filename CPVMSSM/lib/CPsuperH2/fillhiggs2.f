...
*
      ...
      RAUX_H(16)=V1_SB
      RAUX_H(17)=V1_SF
*      print*,'V1:',v1,v1_st,v1_sb,v1_sf
      RAUX_H(18)=V2
      RAUX_H(19)=V2_ST
      RAUX_H(20)=V2_SB
      RAUX_H(21)=V2_SF
*      print*,'V2:',v2,v2_st,v2_sb,v2_sf
      RAUX_H(22)=HT_MT
      RAUX_H(23)=HB_MT
*      print*,'HT,HB (W/O Corrections):',ht_mt,hb_mt
*-------------------------------------------------------------------------
...
*      print*,cdelhb1,cdelhb2
*      print*,cdelht1,cdelht2
...
*.....including the threshold corrections
      ...
      HT_SF=HT_ST*(1.D0+2.D0*BT*DLOG(QSF2/QST2))**0.25D0
      HT_CP=CDABS(1.D0+CDELHT)/(1.D0+CDELHT)
      HB_SB=HB_R
      HB_MT=HB_SB*(1.D0+2.D0*BB*DLOG(MTPOLE_H**2/QSB2))**0.25D0
      HB_SF=HB_SB*(1.D0+2.D0*BB*DLOG(QSF2/QSB2))**0.25D0
...
*
      ...
      RAUX_H(25)=HT_ST
      RAUX_H(26)=HT_SF
*      print*,'HT (W/ Corrections):',ht_mt,ht_st,ht_sf
      RAUX_H(27)=HB_MT
      RAUX_H(28)=HB_SB
      RAUX_H(29)=HB_SF
*      print*,'HB (W/ Corrections):',hb_mt,hb_sb,hb_sf
*
      CAUX_H(1)=HT_CP
      CAUX_H(2)=HB_CP
*      print*,'HT and HB Phases:',ht_cp,hb_cp
*-----------------------------------------------------------------------
...
*
     ...
     .               +OMIX_0(A1,IH)*CMNH(A1,A2)*OMIX_0(A2,JH)
         ENDDO
         ENDDO
