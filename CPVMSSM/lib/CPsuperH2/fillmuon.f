...
*
      ...
      print*,'---------------------------------------------------------'
      print*,'The Electric EDM of muon in cm:'
      print*,'---------------------------------------------------------'
      write(*,8) 'd^E_mu/e[Total]:',deoe_mu(1)*GEVTOCM
      write(321,fmt='("EDMmu",2x,1PE16.8)') deoe_mu(1)*GEVTOCM
      write(*,8) 'd^E_mu/e[C,N,Gl,H]:'
...
*  
       write(*,*) 'IFLAG(1)=', IFLAG(1)
        write(*,*) 'IFLAG(2)=', IFLAG(2)
         write(*,*) 'IFLAG(3)=', IFLAG(3)
          write(*,*) 'IFLAG(4)=', IFLAG(4)
           write(*,*) 'IFLAG(5)=', IFLAG(5)
            write(*,*) 'IFLAG(6)=', IFLAG(6)
             write(*,*) 'IFLAG(7)=', IFLAG(7)
              write(*,*) 'IFLAG(8)=', IFLAG(8)
               write(*,*) 'IFLAG(9)=', IFLAG(9)
                write(*,*) 'IFLAG(10)=', IFLAG(10)
                 write(*,*) 'IFLAG(11)=', IFLAG(11)
                  write(*,*) 'IFLAG(12)=', IFLAG(12)
                   write(*,*) 'IFLAG(13)=', IFLAG(13)
                    write(*,*) 'IFLAG(14)=', IFLAG(14)
                     write(*,*) 'IFLAG(15)=', IFLAG(14)
                      write(*,*) 'IFLAG(16)=', IFLAG(16)
                       write(*,*) 'IFLAG(17)=', IFLAG(17)
                        write(*,*) 'IFLAG(18)=', IFLAG(18)
      write(*,*) 'IFLAG(19)=', IFLAG(19)
      IF(IFLAG(19).EQ.1) THEN
      print*,'---------------------------------------------------------'
      print*,'The SUSY MDM of muon:'
      print*,'---------------------------------------------------------'
      write(*,8) 'a_mu[Total]:',qed_log*mdm_mu(1)
      write(321,fmt='("gmuon",2x,1PE16.8)')  qed_log*mdm_mu(1)
...
*-----------------------------------------------------------------------
 ...
 8    FORMAT(2X,A19,1X,4(1X,E10.4,1X))
