...
!*************************************************************************
      ...
      PROGRAM HBwithCPsuperH2
************************************************************************
* This is modified version of the cpsuperh2.f file which is supplied with 
* CPsuperH2.0 version from 10 June 2009
* (downloaded from http://www.hep.man.ac.uk/u/jslee/CPsuperH.html)
...
*read in input data from the file 'HBwithCPsuperH.input'
      write(*,*) 'call: HBwithCPsuperH < HBwithCPsuperH.input'
*
      DO IP=1,NSMIN
       READ(*,*) SMPARA_H(IP)
      ENDDO
...
*=======================================================================
     ...
     . ,CHC_H)
      ...
      IF(IERR2.GT.0) THEN
       ...
       IF(IFLAG_H(56).EQ.2) write(*,*)'ERROR! IFLAG_H(56) = ',IFLAG_H(56)
       IF(IFLAG_H(56).EQ.3) write(*,*)'ERROR! IFLAG_H(56) = ',IFLAG_H(56)
       IFLAG_H(54)=0
       IFLAG_H(56)=0
       STOP
      ENDIF
