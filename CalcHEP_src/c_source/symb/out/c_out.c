...
typedef char s6[VAR_NAME_SIZE+1];

/* ======================================================== */
typedef char shortname[P_NAME_SIZE+1];
...
{ int   k;
  ...
  { if( k>nCommonVars && (modelvars[k].func || modelvars[k].pwidth)  ) 
        nfunc++; else  nvars++; }
} 
...
static int c_prog_int(int for12)
{
  ...
  /* ======= End of Initialisation ====== */
   ...
   { 
      ...
      forceUG, pathtocomphep,nvars, nfunc, nin,nout,subproc_sq);
