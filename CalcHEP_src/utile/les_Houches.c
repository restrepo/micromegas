    ...
    { char rest[200];
      ...
      { int model=findValW("model")+0.1; 
        ...
        { case 0: if(n1==3) assignValW("tb",val);    break;
          ...
          switch(n1)
          {  
           case    1   : assignValW("MG1"  , val); break;  
           case    2   : assignValW("MG2"  , val); break;  
           case    3   : assignValW("MG3"  , val); break;
           case   11   : assignValW("At"   , val); break;  
           case   12   : assignValW("Ab"   , val); break;  
           case   13   : assignValW("Al"   , val); break;  
           case   21   : assignValW("mH1_2", val); break;
           case   22   : assignValW("mH2_2", val); break;
           case   23   : assignValW("mu",    val); break;
           case   24   : assignValW("MH3",   val); break;
           case   31   : assignValW("Ml1"  , val); break;  
           case   32   : assignValW("Ml2"  , val); break;  
           case   33   : assignValW("Ml3"  , val); break;  
           case   34   : assignValW("Mr1"  , val); break;  
           case   35   : assignValW("Mr2"  , val); break;  
           case   36   : assignValW("Mr3"  , val); break;  
           case   41   : assignValW("Mq1"  , val); break;  
           case   42   : assignValW("Mq2"  , val); break;  
           case   43   : assignValW("Mq3"  , val); break;  
           case   44   : assignValW("Mu1"  , val); break;  
           case   45   : assignValW("Mu2"  , val); break;  
           case   46   : assignValW("Mu3"  , val); break;  
           case   47   : assignValW("Md1"  , val); break;  
           case   48   : assignValW("Md2"  , val); break;  
           case   49   : assignValW("Md3"  , val); break;
...
int writelesh_(int * err, char*CODE,char *f_name,int len1,int len2)
{
  ...
  if(*err<0) fprintf(f,"   3  *\n",-(*err)  );
  if(*err>0) fprintf(f,"   4  *\n", (*err)  ); 
