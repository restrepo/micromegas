...
//  double QSUSY=sqrt(findValW("MASS",91,1,1000006)*findValW("MASS",91,1,2000006));
  ...
  double lDiag  =rDiagonal(2, (REAL) (Ml3*Ml3+Ml*Ml-(1./2.-(SW*SW))*MZ*MZ*c2b),(REAL)( Ml*(Al-mu*tb)), (REAL)(Mr3*Mr3+Ml*Ml-(SW*SW)*MZ*MZ*c2b));
  ...
  double tDiag  =rDiagonal(2, (REAL)(Mt11_+(MtMM*MtMM)), (REAL) (MtMM*Mt12_), (REAL)(Mt22_+MtMM*MtMM));
  ...
  double bDiag  =rDiagonal(2, (REAL)((Mq3*Mq3)+MbMM*MbMM-(1./2.-1./3.*(SW*SW))*(MZ*MZ)*c2b),(REAL)( MbMM*(Ab-mu*tb)), (REAL)(Md3*Md3+MbMM*MbMM-1/3.*(SW*SW)*(MZ*MZ)*c2b));
  ...
  double zero   =initDiagonal();
         zero=0;
  double NeDiag =rDiagonal(4, (REAL)MG1, (REAL)zero, (REAL)(-MZ*SW*cb), (REAL)(MZ*SW*sb), (REAL)MG2, (REAL)( MZ*CW*cb), (REAL)(-MZ*CW*sb),(REAL)( zero),(REAL)( -mu),(REAL)( zero));
  ...
  double chDiag =rDiagonalA(2,(REAL)( MG2), (REAL)(Sqrt2*MW*sb),(REAL)(Sqrt2*MW*cb),(REAL) mu);
...
/*  
  ...
  double la7    =-Lambda7();
*/
  double la1=pow(EE/CW,2)/4+pow(EE/SW,2)/4 ,
         la2=pow(EE/CW,2)/4+pow(EE/SW,2)/4,
         la3=pow(EE/SW,2)/4-pow(EE/CW,2)/4 ,
         la4=-pow(EE/SW,2)/2,
         la5=0,la6=0,la7=0;   
  ...
  double hDiag  =rDiagonal(2, (REAL)Mhh11, (REAL)Mhh12, (REAL)Mhh22);
...
*/
  ...
  fprintf(f,"Block STOPMIX\n");
    fprintf(f," 1 1   %16.8E   # Zt11\n",Zt11);
    fprintf(f," 1 2   %16.8E   # Zt12\n",Zt12);
    fprintf(f," 2 1   %16.8E   # Zt21\n",Zt21);
    fprintf(f," 2 2   %16.8E   # Zt22\n",Zt22);
  
  fprintf(f,"Block SBOTMIX\n"); 
    fprintf(f," 1 1    %16.8E   # Zb11\n",Zb11);
    fprintf(f," 1 2    %16.8E   # Zb12\n",Zb12);
    fprintf(f," 2 1    %16.8E   # Zb21\n",Zb21);
    fprintf(f," 2 2    %16.8E   # Zb22\n",Zb22);


  fprintf(f,"Block STAUMIX\n");
    fprintf(f," 1 1    %16.8E   # Zl11\n",Zl11);
    fprintf(f," 1 2    %16.8E   # Zl12\n",Zl12);
    fprintf(f," 2 1    %16.8E   # Zl21\n",Zl21);
    fprintf(f," 2 2    %16.8E   # Zl22\n",Zl22);
    
  fprintf(f,"Block NMIX\n");  
  fprintf(f," 1 1    %16.8E   # Zn11\n",Zn11);
  fprintf(f," 1 2    %16.8E   # Zn12\n",Zn12);
  fprintf(f," 1 3    %16.8E   # Zn13\n",Zn13);
  fprintf(f," 1 4    %16.8E   # Zn14\n",Zn14);
  fprintf(f," 2 1    %16.8E   # Zn21\n",Zn21);
  fprintf(f," 2 2    %16.8E   # Zn22\n",Zn22);
  fprintf(f," 2 3    %16.8E   # Zn23\n",Zn23);
  fprintf(f," 2 4    %16.8E   # Zn24\n",Zn24);
  fprintf(f," 3 1    %16.8E   # Zn31\n",Zn31);
  fprintf(f," 3 2    %16.8E   # Zn32\n",Zn32);
  fprintf(f," 3 3    %16.8E   # Zn33\n",Zn33);
  fprintf(f," 3 4    %16.8E   # Zn34\n",Zn34);
  fprintf(f," 4 1    %16.8E   # Zn41\n",Zn41);
  fprintf(f," 4 2    %16.8E   # Zn42\n",Zn42);
  fprintf(f," 4 3    %16.8E   # Zn43\n",Zn43);
  fprintf(f," 4 4    %16.8E   # Zn44\n",Zn44);

  
  fprintf(f,"Block UMIX\n");
  fprintf(f," 1 1    %16.8E   # Zu11\n",Zu11);
  fprintf(f," 1 2    %16.8E   # Zu12\n",Zu12);
  fprintf(f," 2 1    %16.8E   # Zu21\n",Zu21);
  fprintf(f," 2 2    %16.8E   # Zu22\n",Zu22);

  fprintf(f,"Block VMIX\n");
  fprintf(f," 1 1    %16.8E   # Zv11\n",Zv11);
  fprintf(f," 1 2    %16.8E   # Zv12\n",Zv12);
  fprintf(f," 2 1    %16.8E   # Zv21\n",Zv21);
  fprintf(f," 2 2    %16.8E   # Zv22\n",Zv22);
