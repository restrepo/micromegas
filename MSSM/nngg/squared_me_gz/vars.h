...
#include "renconst.h"
	...
	integer iint21(3), iint22(3), iint23(3), iint24(3), iint25(2)
	integer iint26(2), iint27(2), iint28(2), iint29(2), iint30(2)
	integer iint31(2), iint32(2), iint33(2), iint34(2), iint35(2)
	integer iint36(2), iint37(3), iint38(3), iint39(3)
	integer iint40(2,2), iint41, iint42, iint43(3), iint44(3)
	integer iint45(3), iint46(3), iint47(3), iint48(3), iint49(3)
	integer iint50(3), iint51(3), iint52(3), iint53(3), iint54(3)
	integer iint55(3), iint56(3), iint57(3), iint58(3), iint59(3)
	integer iint60(3), iint61(3), iint62(3), iint63(3), iint64(3)
	integer iint65(3), iint66(3), iint67(3), iint68(3), iint69(3)
	integer iint70(3), iint71(3), iint72(3), iint73(3), iint74(3)
	integer iint75(3), iint76(3), iint77(3), iint78(3), iint79(3)
	integer iint80(3), iint81(3), iint82(3), iint83(3), iint84(3)
	integer iint85(3), iint86(3), iint87(3), iint88(3), iint89(3)
	integer iint90(3), iint91(3), iint92(3), iint93(3), iint94(3)
	integer iint95(3), iint96(3), iint97(3), iint98(3), iint99(3)
	integer iint100(3), iint101(3), iint102(3), iint103(3)
	integer iint104(3), iint105(3), iint106(3), iint107(3)
	integer iint108(3), iint109(3), iint110(3), iint111(3)
	integer iint112(3), iint113(3), iint114(3), iint115(3)
	integer iint116(3), iint117(3), iint118(3), iint119(3)
	integer iint120(3), iint121(3), iint122(3), iint123(3)
	integer iint124(3), iint125(3), iint126(3), iint127(3)
	integer iint128(3), iint129(3), iint130(3), iint131(3)
	integer iint132(3), iint133(3), iint134(3), iint135(3)
	integer iint136(3), iint137(3), iint138(3), iint139(3)
	integer iint140(3), iint141(3), iint142(3), iint143(3)
	integer iint144(3), iint145(2), iint146(2), iint147(2)
	integer iint148(2), iint149(2), iint150(2), iint151(2)
	integer iint152(2), iint153(2), iint154(2), iint155(2)
	integer iint156(2), iint157(2), iint158(2), iint159(2)
	integer iint160(2,2), iint161(2,2), iint162(2,2), iint163(2,2)
	integer iint164(2), iint165(2), iint166(2,2), iint167(2,2)
	integer iint168(2), iint169(2), iint170(2,2), iint171(2,2)
	integer iint172(2,2), iint173(2,2), iint174(2,2), iint175(2,2)
	integer iint176(2,2), iint177(2,2)
