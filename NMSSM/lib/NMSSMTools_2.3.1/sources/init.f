...
*******************************************************************
	...
	DOUBLE PRECISION ppHA(500,500),xsec
...
*   Alpha_EM(0)
	ALEM0= 1.D0/137.036D0
*   Alpha_s at MZ:
	ALSMZ= 0.1172D0
*   Electroweak parameters:
	GF= 1.16639D-5
*   Alpha_em at MZ (used in RGES):
	ALEMMZ= 1.D0/127.92D0
*   Z, W pole masses:
	MZ= 91.187D0
	MW= 80.42D0
*   Lepton masses:		
...
*   (Used only if OMGFLAG=1)
	...
	ENDDO
	DO I=1,NBIN
	  x(I)=(NBIN-I)*DLOG10(Emin)/(NBIN-1.D0)
	ENDDO
...
*   Lower limit on charged Higgs mass:
	...
	FILENAME=catpath(EXPCON_PATH,'ppHA.dat')
	OPEN(11,FILE=FILENAME,STATUS='UNKNOWN',ERR=1)
	DO I=1,500
	 READ(11,*)(ppHA(I,J),J=1,500)
	ENDDO
	CLOSE(11)
