...
class ReadUserInput:
    ...
    def get_nextreducedcouplings(self):
        ...
        accepted_C = ["ff", "uu", "tt", "cc", "dd", "bb", "tautau", "VV",
        ...
        for child in red_coupl:
            if child.tag == "C":
                if "to" not in child.attrib:
                    ...
                    if child.attrib["to"] in ["ff", "uu", "tt", "cc", "dd", "bb", "tautau","mumu"]:
        ...
        # with the multiparticle labels "uu" and "dd"---it should be treated
        # in the very end
        ...
        #     processes)
        mandatory_particles = ["WW", "ZZ", "tt", "cc", "mumu", "bb", "tautau"]
    ...
    def get_nextsignalstrengths(self):
        ...
        accepted_decay = ["gammagamma", "VV", "WW", "ZZ", "bb", "tautau",
                          "dd", "uu", "cc", "ff", "Zgamma", "mumu", "invisible", "gg"]
        ...
        multidecay = {"VV": ["WW", "ZZ"], "uu": ["cc"], "dd": ["bb", "tautau","mumu"]}
        multidecay2 = {"ff": ["cc", "bb", "tautau","mumu"]}
        # two separate dicts for prod and decay because "ff" is a special case
        # since it overlaps with the multiparticle labels "uu" and "dd"
        ...
        for key,mu_value in mup.items():
            if key == "extra":
                continue
            prod,decay = key
            if prod in multiprod or prod in multiprod2:
                del mup[prod,decay]
