...
*******************************************************************
      ...
      INTEGER NPROB,NPAR
      PARAMETER (NPROB=52,NPAR=25)
      INTEGER IFAIL,I,ITER,ITERMU,Q2FIX,OMGFLAG,MAFLAG,MOFLAG,GMFLAG
...
*******************************************************************
      ...
      INTEGER I,NLINE,INL,ICH,IX,IVAL,Q2FIX,GMFLAG,GMUFLAG,HFLAG,Z3FLAG
      INTEGER N0,NLOOP,NBER,NPAR,OMGFLAG,MAFLAG,MOFLAG,PFLAG,ERR,VFLAG
...
*   READ EXTPAR
      ELSEIF(CHBLCK(1:6).EQ.'EXTPAR')THEN
       ...
       IF(IX.EQ.71) DHMES=VAL
       IF(IX.EQ.73) LPPMES=VAL
       IF(IX.EQ.74) LTTMES=VAL
       IF(IX.EQ.75) LUMES=VAL
       IF(IX.EQ.76) LDMES=VAL
       IF(IX.EQ.77) LTMES=VAL
       IF(IX.EQ.78) LBMES=VAL
       IF(IX.EQ.79) LLMES=VAL
...
*   Check for errors
 ...
 29   ERR=0
      ...
      IF(XISINP.NE.1d99 .AND. MSINP.NE.1d99)THEN
       ...
       ERR=1
      ENDIF
      IF(GMFLAG.EQ.1 .AND. ALINP.NE.1d99)THEN
       WRITE(0,1)"GMFLAG=1 => ALINP CANNOT BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
      IF(GMFLAG.EQ.1 .AND. MSINP.NE.1d99)THEN
       WRITE(0,1)"GMFLAG=1 => MSINP CANNOT BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
...
*********************************************************************      
      ...
      INTEGER I,IFAIL,OMGFLAG,MAFLAG,MOFLAG,PFLAG,GMFLAG,Q2FIX,VFLAG
     ...
     .  CST,CSB,CSL,MSMU1,MSMU2,MSMUNT,CSMU
      ...
      WRITE(17,900) 2,"4.5.1      # Version number"
     ...
     . WRITE(17,900) 3,"# Excluded H_125->AA->4mu (CMS)"
      IF((IFAIL.EQ.0 .OR. IFAIL.EQ.10 .OR. IFAIL.GE.18)
     . .AND. (SMASS(1).LT.1d0 .OR. PMASS(1).LT.1d0))
     . WRITE(17,900) 3,"# Branching ratios of Higgs states < 1 GeV not
     . reliable"
...
c      WRITE(17,921) 12,GMFLAG,"GMSB scenario at MMESS"
     ...
     . WRITE(17,920) 70,MSREF,"MS^2_REF"
      IF(DHMES.NE.0d0)
     .  WRITE(17,901) 71,DHMES,"DH AT THE MES SCALE"
      IF(LPPMES.NE.0d0)
     .  WRITE(17,901) 71,LPPMES,"LPP AT THE MES SCALE"
      IF(LTTMES.NE.0d0)
     .  WRITE(17,901) 71,LTTMES,"LTT AT THE MES SCALE"
      IF(LUMES.NE.0d0)
     .  WRITE(17,901) 71,LUMES,"LU AT THE MES SCALE"
      IF(LDMES.NE.0d0)
     .  WRITE(17,901) 71,LDMES,"LD AT THE MES SCALE"
      IF(LTMES.NE.0d0)
     .  WRITE(17,901) 71,LTMES,"LT AT THE MES SCALE"
      IF(LBMES.NE.0d0)
     .  WRITE(17,901) 71,LBMES,"LB AT THE MES SCALE"
      IF(LLMES.NE.0d0)
     .  WRITE(17,901) 71,LLMES,"LL AT THE MES SCALE"
     ...
     .        "HTAU(MMES,DR_bar)"
      ...
      WRITE(17,901) 11,DHMES,"DH"
      WRITE(17,901) 12,M3HMES,"M3H^2"
      WRITE(17,901) 13,LPPMES,"LPP"
      WRITE(17,901) 14,LTTMES,"LTT"
      WRITE(17,901) 15,LUMES,"LU"
      WRITE(17,901) 16,LDMES,"LD"
      WRITE(17,901) 17,LTMES,"LT"
      WRITE(17,901) 18,LBMES,"LB"
      WRITE(17,901) 19,LLMES,"LL"
      WRITE(17,899) "# "
     ...
     .        "g1(MGUT), GUT normalization"
       ...
       WRITE(17,903) 3,3,HTGUT/DSQRT(DABS(HTGUT)),"HTOP(MGUT)"
       WRITE(17,907) "BLOCK GUTYD Q=",MGUT," # (GUT SCALE)"
       WRITE(17,903) 3,3,HBGUT/DSQRT(DABS(HBGUT)),"HBOT(MGUT)"
       WRITE(17,907) "BLOCK GUTYE Q=",MGUT," # (GUT SCALE)"
       WRITE(17,903) 3,3,HLGUT/DSQRT(DABS(HLGUT)),"HTAU(MGUT)"
     ...
     .        "g1(MLANDAU), (GUT normalization)"
       ...
       WRITE(17,903) 3,3,HTGUT/DSQRT(DABS(HTGUT)),"HTOP(MLANDAU)"
       WRITE(17,907) "BLOCK LANYD MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(17,903) 3,3,HBGUT/DSQRT(DABS(HBGUT)),"HBOT(MLANDAU)"
       WRITE(17,907) "BLOCK LANYE MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(17,903) 3,3,HLGUT/DSQRT(DABS(HLGUT)),"HTAU(MLANDAU)"
      ...
      WRITE(17,901) 16,FTMES(16),"PM=LPP"
      WRITE(17,901) 17,FTMES(17),"PM=LTT"
      WRITE(17,901) 18,FTMES(18),"PM=LU"
      WRITE(17,901) 19,FTMES(19),"PM=LD"
      WRITE(17,901) 20,FTMES(20),"PM=LT"
      WRITE(17,901) 21,FTMES(21),"PM=LB"
      WRITE(17,901) 22,FTMES(22),"PM=LL"
      WRITE(17,901) 23,FTMES(23),"MAX"
      WRITE(17,914) 24,INT(FTMES(24)),"IMAX"
 ...
 1    WRITE(18,899) "# "
      ...
      WRITE(18,900) 2,"4.5.1      # Version number"
