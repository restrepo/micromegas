...
************************************************************************
      ...
      PARAMETER (NFL=17,NPROB=52,NPAR=25)
 ...
 14   IF(IFAIL.EQ.-1)THEN
      ...
      ELSE
       ...
       IF(M0DEV.EQ.0d0)THEN
        M0=M0CEN
       ELSE
        M0=M0CEN+MAX(DABS(M0CEN),M0MIN)*M0DEV*GAU(IDUM)
        IF(M0.LE.1d0)M0=1d0
       ENDIF
       IF(M12DEV.EQ.0d0)THEN
        M12=M12CEN
       ELSE
        M12=M12CEN+MAX(DABS(M12CEN),M12MIN)*M12DEV*GAU(IDUM)
        IF(M12.LE.1d0)M12=1d0
       ENDIF
