...
C-----------
      ...
      write(nout,49) 'selectron_R 3-body decays'
       write(nout,103)
      if(brselrstaustar.ne.0d0) then
      write(nout,104) brselrstaustar,3,-istau1,ie,-itau,
     .'BR(~e_R -> ~tau_1* e- taub)' 
      endif
      if(brselrstau.ne.0d0) then
