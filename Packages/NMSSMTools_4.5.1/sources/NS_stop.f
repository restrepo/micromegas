...
c -------------------------------------------------------------------- c
     ...
     .              xintegstsntau(i,j)+2d0*xintegstsel(i,j)+
     .              xintegstbsbst(i,j)+xintegstbbsbt(i,j)+
     .              xintegsttausbnu(i,j)+2d0*xintegstelsbnu(i,j)+
     .              2d0*xintegstupsbdow(i,j)
            end do
            stoptotmulti(i) = stoptotmulti(i)+2d0*xintegstsnel(i)
            if(i.eq.2) then
...
*
     ...
     C     CST,CSB,CSL,ase2,ase1,asne1,csmu
      ...
      amh12=-sdmhd2 
      amsc1=dsqrt(sdmuq**2+
     .      (0.5d0-2d0/3d0*sw**2)*amz**2*dcos(2d0*beta))
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstopw(ni,nj)=g2s**2/32d0/(2d0*pi)**3*gmst(ni)*
     .                            sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstoph(ni,nj)=g2s**2/32d0/(2d0*pi)**3*gmst(ni)*
     .                            sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegststau(ni,nj)=g2s**2/32d0/(2d0*pi)**3*gmst(ni)*
     .              sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstsntau(ni,nj)=g2s**2/32d0/(2d0*pi)**3*
     .              gmst(ni)*sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstsel(ni,nj)=g2s**2/32d0/(2d0*pi)**3*gmst(ni)*
     .              sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstbbsbt(ni,nj)=1d0/32d0/(2d0*pi)**3*gmst(ni)*
     .              sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu1,xmu2,xmu3,nx1t,ny1t,sum1)
              xintegsttausbnu(ni,nj)=g2s**2/32d0/(2d0*pi)**3*
     .              gmst(ni)*sum1
...
c -------------------------------------------------------------------- c
     ...
     .                     xmu1,xmu2,xmu3,nx1t,ny1t,sum1)
               xintegstelsbnu(ni,nj)=g2s**2/32d0/(2d0*pi)**3*
     .              gmst(ni)*sum1
...
c -------------------------------------------------------------------- c
     ...
     .               xmu2,xmu3,nx1t,ny1t,sum1)
         xintegst2st1ee=g2s**2/32d0/(2d0*pi)**3*gmst(2)*sum1*1d0
...
c -------------------------------------------------------------------- c
     ...
     .               xmu2,xmu3,nx1t,ny1t,sum1)
         xintegst2st1nunu=g2s**2/32d0/(2d0*pi)**3*gmst(2)*sum1*1d0
...
c -------------------------------------------------------------------- c
     ...
     .               xmu2,xmu3,nx1t,ny1t,sum1)
         xintegst2st1tautau=g2s**2/32d0/(2d0*pi)**3*gmst(2)*sum1*1d0
