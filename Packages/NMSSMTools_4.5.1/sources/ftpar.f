...
*     FTMES(14) --> PM=g3
*     FTMES(15) --> PM=MMESS
*     FTMES(16) --> PM=lambda_PP
*     FTMES(17) --> PM=lambda_TT
*     FTMES(18) --> PM=lambda_SU
*     FTMES(19) --> PM=lambda_SD
*     FTMES(20) --> PM=lambda_T
*     FTMES(21) --> PM=lambda_B
*     FTMES(22) --> PM=lambda_L
*     FTMES(23) --> MAX(FTGUT(i))
*     FTMES(24) --> i FOR FTMAX
*
...
*   MES scale parameters
	...
	ENDIF
     ...
     .       +SP2(-2d0*X/(1d0-X))/2d0)
      ...
      IF(GMFLAG.EQ.1)THEN
       Y(12)=-COEF*PM(1)
     .       *(PM(3)+2d0*PM(16)+3d0*PM(17)+3d0*PM(18)+3d0*PM(19))
      ELSE
       Y(12)=PM(4)
      ENDIF
      IF(PM(10).NE.0d0)THEN
       IF(GMFLAG.EQ.1)THEN
        Y(13)=-3d0*COEF*PM(1)
     .        *(PM(3)+2d0*PM(16)+3d0*PM(17)+2d0*PM(18)+2d0*PM(19))
       ELSE
        Y(13)=3d0*PM(4)
       ENDIF
      ELSE
       Y(13)=0d0
      ENDIF
      Y(14)=-COEF*PM(1)*(PM(18)+3d0*PM(20)+PM(21))
      Y(15)=-COEF*PM(1)*(PM(19)+PM(20)+3d0*PM(21))
      Y(16)=-COEF*PM(1)*(PM(19)+3d0*PM(22))
      Y(17)=COEF*(5d0/6d0*ALP1**2+3d0/2d0*ALP2**2)*N5*F2*PM(1)**2
     .     +(COEF*PM(1))**2*
     .      (-PM(9)*(PM(3)+2d0*PM(16)+3d0*PM(17)+3d0*PM(19))
     .       +PM(18)*(4d0*PM(18)+2d0*PM(19)+2d0*PM(9)+2d0*PM(10)
     .       +3d0*PM(21)+PM(22)-PM(12)-3d0*PM(13))
     .       -3d0*PM(11)*(3d0*PM(20)+PM(21))
     .       +2d0*DSQRT(PM(9)*PM(16)*PM(18)*PM(19))
     .       +6d0*DSQRT(PM(9)*PM(18)*PM(21)*HB)
     .       +2d0*DSQRT(PM(9)*PM(18)*PM(22)*HL))
      Y(18)=COEF*(5d0/6d0*ALP1**2+3d0/2d0*ALP2**2)*N5*F2*PM(1)**2
     .     +(COEF*PM(1))**2*
     .      (-PM(9)*(PM(3)+2d0*PM(16)+3d0*PM(17)+3d0*PM(18))
     .       +PM(19)*(4d0*PM(19)+2d0*PM(18)+2d0*PM(9)+2d0*PM(10)
     .       +3d0*PM(20)-PM(12)-3d0*PM(13))
     .       -3d0*HB*(3d0*PM(21)+PM(20))-3d0*HL*PM(22)
     .       +2d0*DSQRT(PM(9)*PM(16)*PM(18)*PM(19))
     .       +6d0*DSQRT(PM(9)*PM(19)*PM(20)*PM(11)))
      IF(GMFLAG.EQ.1)THEN
       Y(19)=PM(1)**2/(4d0*PI)**4*(7d0/5d0*PM(3)**2-4d0*PM(10)**2*PM(3)
     .      -(16d0*PM(14)+6d0*PM(13)+10d0/3d0*PM(12))*PM(3)/5d0
     .      +PM(18)*(8d0*PM(18)+4d0*PM(9)-8d0*PM(10)+6d0*PM(11)
     .       +6d0*PM(21)+2d0*PM(22)+12d0*PM(17)+16d0*PM(16)-2d0*PM(12)
     .       -6d0*PM(13))
     .      +PM(19)*(8d0*PM(18)+4d0*PM(9)-8d0*PM(10)+6d0*PM(20)+6d0*HB
     .       +2d0*HL+12d0*PM(17)+16d0*PM(16)-2d0*PM(12)-6d0*PM(13))
     .      +PM(16)*(8d0*PM(16)-8d0*PM(10)-2d0*PM(12)-6d0*PM(13))
     .      +PM(17)*(15d0*PM(17)-12d0*PM(10)-4d0/3d0*PM(12)-16d0*PM(13))
     .      +8d0*PM(18)*PM(19)+12d0*PM(16)*PM(17)
     .      +16d0*DSQRT(PM(9)*PM(19)*PM(18)*PM(16))
     .      +12d0*DSQRT(PM(9)*PM(19)*PM(20)*PM(11))
     .      +12d0*DSQRT(PM(9)*PM(18)*PM(21)*HB)
     .      +4d0*DSQRT(PM(9)*PM(18)*PM(22)*HL))
      ELSE
       Y(19)=PM(2)
      ENDIF
