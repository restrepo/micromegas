      SUBROUTINE HDECAY(MH,BRJJ,BREE,BRMM,BRLL,BRSS,BRCC,
     .        BRBB,BRTT,BRWW,BRZZ,BRGG,BRZG)
      ...
      DOUBLE PRECISION WIDTH,BRJJ,BREE,BRMM,BRLL,BRSS,BRCC
      ...
      DOUBLE PRECISION HTWW,HTZZ,MPI,MEL
...
*  Branching ratios
      ...
      SUBROUTINE ADECAY(MA,BRJJ,BREE,BRMM,BRLL,BRSS,BRCC,
     .        BRBB,BRTT,BRGG,BRZG)
      ...
      DOUBLE PRECISION SQR2,EPS,FQCD,XFAC,X,Y,RATCOUP,RAT
      DOUBLE PRECISION HJJ,HEE,HMM,HLL,HSS,HCC,HBB,HTT,HGG,HZG
      DOUBLE PRECISION HS1,HS2,HC1,HC2,HB1,HB2,HT1,HT2,DCC,DBB
      DOUBLE PRECISION WIDTH,BRJJ,BREE,BRMM,BRLL,BRSS,BRCC
      ...
      DOUBLE PRECISION ALSMZ,ALEMMZ,GF,g1,g2,S2TW,MPI,MEL
      DOUBLE PRECISION MS,MC,MB,MBP,MT,MTAU,MMUON,MZ,MW
...
*   Branching ratios
      ...
      WIDTH=HJJ+HEE+HMM+HLL+HSS+HCC+HBB+HTT+HGG+HZG
      BRJJ= HJJ/WIDTH
      BREE= HEE/WIDTH
      BRMM= HMM/WIDTH
      BRLL= HLL/WIDTH
