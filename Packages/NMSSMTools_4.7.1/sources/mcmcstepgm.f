      ...
      INTEGER IFAIL,I,OMGFLAG,MAFLAG,MOFLAG,GMFLAG,NTOT,IDUM,NPROB,JM,JL
      ...
      DOUBLE PRECISION MSREF,D,DMIN,DELMB
...
c      IF(MCFLAG.EQ.3 .OR. MCFLAG.EQ.4 .OR. MCFLAG.EQ.5)THEN
c       X=X+FTMES(NMES+1)
c      ELSEIF(MCFLAG.EQ.6 .OR. MCFLAG.EQ.7 .OR. MCFLAG.EQ.8)THEN
c       X=X+MGL
c      ELSE
c       X=X+1d0
c      ENDIF
      ...
      IF(MCFLAG/3.EQ.1)THEN
       IF(MGL.GT.2.5d3)THEN
        X=X+(MGL/2.5d3)*1d5
       ENDIF
      ELSEIF(MCFLAG/3.EQ.2)THEN
       X=X+MGL
      ELSEIF(MCFLAG/3.EQ.3)THEN
       IF(MST1.GT.2.5d3)THEN
        X=X+(MST1/2.5d3)*1d5
       ENDIF
      ELSEIF(MCFLAG/3.EQ.4)THEN
       X=X+MST1
      ELSE
       X=X+1d0
      ENDIF
