...
*   Check for errors
 ...
 29   ERR=0
      ...
      IF(GMFLAG.NE.2 .AND. LTTMES.NE.0d0)THEN
       ...
       ERR=1
      ENDIF
      IF(GMFLAG.EQ.0 .AND. LUMES.NE.0d0)THEN
       WRITE(0,1)"GMFLAG=/=1,2 => LU CANNOT BE GIVEN IN BLOCK EXTPAR"
       ERR=1
      ENDIF
      IF(GMFLAG.EQ.0 .AND. LDMES.NE.0d0)THEN
      ...
      IF(GMFLAG.EQ.0 .AND. LBMES.NE.0d0)THEN
       ...
       ERR=1
      ENDIF
      IF(GMFLAG.EQ.0 .AND. LLMES.NE.0d0)THEN
...
*********************************************************************
     ...
     . WRITE(17,920) 72,D,"DELTA"
      IF(GMFLAG.EQ.1 .AND. XIU.NE.0d0)
     .  WRITE(17,901) 73,XIU,"XiU at MGUT"
      IF(GMFLAG.EQ.2 .AND. LPPMES.NE.0d0)
     .  WRITE(17,901) 74,LPPMES,"LPP at MMES"
      IF(GMFLAG.EQ.2 .AND. LTTMES.NE.0d0)
     .  WRITE(17,901) 75,LTTMES,"LTT at MMES"
      IF(GMFLAG.NE.0 .AND. LUMES.NE.0d0)
     .  WRITE(17,901) 76,LUMES,"LU at MMES"
      IF(GMFLAG.NE.0 .AND. LDMES.NE.0d0)
     ...
     .  WRITE(17,901) 79,LBMES,"LB at MMES"
      IF(GMFLAG.NE.0 .AND. LLMES.NE.0d0)
     ...
     .   "# Exp. 2 Sigma: 2.206E-3 < epsK < 2.250E-3:"
      WRITE(17,907) "# ",epsK,"   epsK in ps-1"
      WRITE(17,907)
...
*  From IF(OUTFLAG.NE.1)
     ...
     .        "HTAU(MMES,DR_bar)"
      ...
      WRITE(17,901) 21,MHDMES,"M_HD"
      WRITE(17,901) 22,MHUMES,"M_HU"
