...
*   Check for errors
 ...
 29   ERR=0
      ...
      IF(GMFLAG.LT.0 .OR. GMFLAG.GT.2)THEN
       WRITE(0,1)"GMFLAG MUST BE IN [0-2]"
       ERR=1
      ENDIF
...
*********************************************************************
     ...
     . WRITE(0,30)" MSP: ",MSPN,MSPNN,DEV(MSPN,MSPNN)
       IF(GMFLAG.EQ.1 .AND. (XIUN.NE.0d0 .OR. XIUNN.NE.0d0))
     . WRITE(0,30)" XIU: ",XIUN,XIUNN,DEV(XIUN,XIUNN)
       IF(GMFLAG.EQ.2 .AND. (LPPN.NE.0d0 .OR. LPPNN.NE.0d0))
     . WRITE(0,30)" LPP: ",LPPN,LPPNN,DEV(LPPN,LPPNN)
       IF(GMFLAG.EQ.2 .AND. (LTTN.NE.0d0 .OR. LTTNN.NE.0d0))
     . WRITE(0,30)" LTT: ",LTTN,LTTNN,DEV(LTTN,LTTNN)
       IF(GMFLAG.NE.0 .AND. (LUN.NE.0d0 .OR. LUNN.NE.0d0))
     . WRITE(0,30)" LU: ",LUN,LUNN,DEV(LUN,LUNN)
       IF(GMFLAG.NE.0 .AND. (LDN.NE.0d0 .OR. LDNN.NE.0d0))
     ...
     . WRITE(0,30)" LB: ",LBN,LBNN,DEV(LBN,LBNN)
       IF(GMFLAG.NE.0 .AND. (LLN.NE.0d0 .OR. LLNN.NE.0d0))
