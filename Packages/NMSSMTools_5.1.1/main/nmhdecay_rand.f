...
************************************************************************
      ...
      PARAMETER (NFL=13,NPROB=62,NPAR=25)
      ...
      INTEGER GMUFLAG,HFLAG,NMSFLAG,CFLAG(5)
      INTEGER NTOT,IDUM,NM1,NM2,NM3,NTB,NL,NK,NAL,NAK,NMU
      INTEGER NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP,NAQ,NMQ
     ...
     . NAL,NAK,NMU,NMUP,NMSP,NM3H,NMA,NMP,NAQ,NMQ
...
*   Beginning of the scan
      ...
      ELSE
       IF(NAQ.EQ.0)THEN
        PAR(12)=AQMIN+(AQMAX-AQMIN)*RAN2(IDUM)
       ELSE
        PAR(12)=AQMIN*(AQMAX/AQMIN)**RAN2(IDUM)
       ENDIF
      ENDIF
...
*******************************************************************
      ...
      INTEGER NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP,NAQ,NMQ,CFLAG(5)
...
*********************************************************************
     ...
     . MSFLAG,AKFLAG,ALFLAG
      ...
      WRITE(0,10)"  convergence problem              ",NFAIL(13)
      WRITE(0,*)
     ...
     .  WRITE(0,20)" - (g-2)_muon                                     "
      ...
      IF(TOT.GT.0)THEN
       ...
       ENDIF
       WRITE(0,30)" AU3: ",AQN,AQNN,DEV(AQN,AQNN)
