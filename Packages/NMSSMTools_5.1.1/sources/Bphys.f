      SUBROUTINE BOTTOMONIUM(PAR,PROB)
...
***********************************************************************
      ...
      DOUBLE PRECISION PAR(*),PROB(*),PI,SQR2
      ...
      DOUBLE PRECISION BRSUSY(5),WIDTH(5),MBQM,MA,MH,RMAX,CB(5)
...
*
     ...
     .       BRBTAUNUexpMax,BRSGexpmin,BRSGexpMax
      ...
      DOUBLE PRECISION ffp,ggp,gg0,S0,etaB
...
!      enddo
      ...
      tau_Bs=1.607d0/(6.58211915d-13)      ! [1']
      dtau_Bs=0.020d0                      ! rel. uncertainty 2 sigma
...
*      0.5015ps-1 < DMd=0.5055ps-1 < 0.5095ps-1
      DMdexpmin=0.5015d0
      DMdexpMax=0.5095d0
...
*      RD* from [11']
      RDs_taulexpmin=0.322-2d0*0.022d0
      RDs_taulexpmax=0.322+2d0*0.022d0
