...
c       1) Squared mass matrix in the format [[Re,Im],[-Im,Re]]
      ...
      MNEU2(1,3)=dsqrt(g1/2.d0)*(M1r*vu*DDCOS(PhiM1)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(3,1)=dsqrt(g1/2.d0)*(M1r*vu*DDCOS(PhiM1)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(6,8)=dsqrt(g1/2.d0)*(M1r*vu*DDCOS(PhiM1)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(8,6)=dsqrt(g1/2.d0)*(M1r*vu*DDCOS(PhiM1)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(1,8)=dsqrt(g1/2.d0)*(-M1r*vu*DDSIN(PhiM1)
     .                                 +mur*vd*DDSIN(Phi01))
      MNEU2(3,6)=dsqrt(g1/2.d0)*(M1r*vu*DDSIN(PhiM1)
     .                                 -mur*vd*DDSIN(Phi01))
      MNEU2(8,1)=dsqrt(g1/2.d0)*(-M1r*vu*DDSIN(PhiM1)
     .                                 +mur*vd*DDSIN(Phi01))
      MNEU2(6,3)=dsqrt(g1/2.d0)*(M1r*vu*DDSIN(PhiM1)
     .                                 -mur*vd*DDSIN(Phi01))

      MNEU2(1,4)=-dsqrt(g1/2.d0)*(M1r*vd*DDCOS(PhiM1)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(4,1)=-dsqrt(g1/2.d0)*(M1r*vd*DDCOS(PhiM1)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(6,9)=-dsqrt(g1/2.d0)*(M1r*vd*DDCOS(PhiM1)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(9,6)=-dsqrt(g1/2.d0)*(M1r*vd*DDCOS(PhiM1)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(1,9)=dsqrt(g1/2.d0)*(M1r*vd*DDSIN(PhiM1)
     .                                 -mur*vu*DDSIN(Phi01))
      MNEU2(9,1)=dsqrt(g1/2.d0)*(M1r*vd*DDSIN(PhiM1)
     .                                 -mur*vu*DDSIN(Phi01))
      MNEU2(4,6)=dsqrt(g1/2.d0)*(-M1r*vd*DDSIN(PhiM1)
     .                                 +mur*vu*DDSIN(Phi01))
      MNEU2(6,4)=dsqrt(g1/2.d0)*(-M1r*vd*DDSIN(PhiM1)
     .                                 +mur*vu*DDSIN(Phi01))
      ...
      MNEU2(2,3)=-dsqrt(g2/2.d0)*(M2r*vu*DDCOS(PhiM2)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(3,2)=-dsqrt(g2/2.d0)*(M2r*vu*DDCOS(PhiM2)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(7,8)=-dsqrt(g2/2.d0)*(M2r*vu*DDCOS(PhiM2)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(8,7)=-dsqrt(g2/2.d0)*(M2r*vu*DDCOS(PhiM2)
     .                                 +mur*vd*DDCOS(Phi01))
      MNEU2(2,8)=dsqrt(g2/2.d0)*(M2r*vu*DDSIN(PhiM2)
     .                                 -mur*vd*DDSIN(Phi01))
      MNEU2(8,2)=dsqrt(g2/2.d0)*(M2r*vu*DDSIN(PhiM2)
     .                                 -mur*vd*DDSIN(Phi01))
      MNEU2(3,7)=dsqrt(g2/2.d0)*(-M2r*vu*DDSIN(PhiM2)
     .                                 +mur*vd*DDSIN(Phi01))
      MNEU2(7,3)=dsqrt(g2/2.d0)*(-M2r*vu*DDSIN(PhiM2)
     .                                 +mur*vd*DDSIN(Phi01))

      MNEU2(2,4)=dsqrt(g2/2.d0)*(M2r*vd*DDCOS(PhiM2)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(4,2)=dsqrt(g2/2.d0)*(M2r*vd*DDCOS(PhiM2)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(7,9)=dsqrt(g2/2.d0)*(M2r*vd*DDCOS(PhiM2)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(9,7)=dsqrt(g2/2.d0)*(M2r*vd*DDCOS(PhiM2)
     .                                 +mur*vu*DDCOS(Phi01))
      MNEU2(2,9)=dsqrt(g2/2.d0)*(-M2r*vd*DDSIN(PhiM2)
     .                                 +mur*vu*DDSIN(Phi01))
      MNEU2(9,2)=dsqrt(g2/2.d0)*(-M2r*vd*DDSIN(PhiM2)
     .                                 +mur*vu*DDSIN(Phi01))
      MNEU2(7,4)=dsqrt(g2/2.d0)*(M2r*vd*DDSIN(PhiM2)
     .                                 -mur*vu*DDSIN(Phi01))
      MNEU2(4,7)=dsqrt(g2/2.d0)*(M2r*vd*DDSIN(PhiM2)
     .                                 -mur*vu*DDSIN(Phi01))
...
c      Pseudomasses
     ...
     . -2.d0*mur*DDCOS(Phi01)
     .                 *(NEU(I,3,1)*NEU(I,4,1)-NEU(I,3,2)*NEU(I,4,2))
     . -2.d0*mur*DDSIN(Phi01)
...
c      aux=-aux
      ...
      DO J=1,5
       aux1=NEU(I,J,1)
       aux2=NEU(I,J,2)
       NEU(I,J,1)=aux1*DDCOS(aux/2.d0)-aux2*DDSIN(aux/2.d0)
       NEU(I,J,2)=aux1*DDSIN(aux/2.d0)+aux2*DDCOS(aux/2.d0)
