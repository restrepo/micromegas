...
\verb|dNdE| which by default has $Nstep=200$ elements.  
...
which displays several spectra. Here {\tt title  } contains some text, {\tt Emin,Emax} are the lower and upper limits, and {\tt N} is the number of spectra to display.
...
the regions where the  integrand has peaks. Non-zero error code {\it err} means\\
1: NaN in integrand\\
2: Integration needs too many points\\
3: Too deep recursion\\
In case of error {\it simpson} returns result of 7 points Gauss integration. 
