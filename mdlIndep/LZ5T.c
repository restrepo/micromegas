...
{  int err;
   ...
   displayPlot("cs", "M[GeV]", 9, 10000,1,1,"LZ5T",0,LZ5T,NULL);
exit(0);
...
double vS0(double T) { return vSigma( T, 1E-5 ,0);}
// VZdecay=0; VWdecay=0; cleanDecayTable();
// displayPlot("vsigma 0","T", 1, 4, 0, 1, "",0,vS0,NULL);
 VZdecay=1; VWdecay=1; cleanDecayTable();
// displayPlot("vsigma 1","T", 1, 4, 0, 1, "",0,vS0,NULL);
//exit(0);  
    
  printf("\n==== Calculation of relic density =====\n");  
     Omega=darkOmega(&Xf,fast,Beps,&err);
     displayPlot("Y","T",Tend,Tstart, 0,2,"Y",0,YF,NULL,
                                                "Yeq",0,Yeq,NULL);
