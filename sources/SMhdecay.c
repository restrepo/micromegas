...
double widthSMh(double Mh){  return polint4(Mh,101,MH,width);}
double brSMhGG(double Mh) {  return polint4(Mh,101,MH,brG);  }
double brSMhAA(double Mh) {  return polint4(Mh,101,MH,brA);  }

double widthsmh_(double* Mh){ return polint4(*Mh,101,MH,width);}
double brsmhgg_(double*Mh)  { return polint4(*Mh,101,MH,brG);  }
double brsmhaa_(double*Mh)  { return polint4(*Mh,101,MH,brA);  }
