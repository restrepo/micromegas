...
//printf("vs1100T[%d]=%e\n",i,vs1100T[i]);          
  ...
  {
    if(CDM1 && CDM2)
    {  displayFunc("vs1120", vs1120F,Tend,Tstart,1,"T");
       displayFunc("vs1210",vs1210F,Tend,Tstart,1,"T");
       if(Mcdm1<Mcdm2) displayFunc("vs2211",vs2211F,Tend,Tstart,1,"T");
       else            displayFunc("vs1122",vs1122F,Tend,Tstart,1,"T");
    }
    if(CDM2) displayFunc("vs2200",vs2200F,Tend,Tstart,1,"T");
    if(CDM1) displayFunc("vs1100",vs1100F,Tend,Tstart,1,"T");
  }  
}
